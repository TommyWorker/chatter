...
function clear_onclick() {
    ...
    // Submit
    document.getElementById("form_list").action = "/user/list";
...
function download_onclick() {
    ...
    // Submit
    document.getElementById("form_list").action = "/user/list/download";
    document.getElementById("form_list").submit(this.form);
...
function set_search_cookie() {
    ...
    document.cookie = "txt_mail_address=" + encodeURIComponent(document.getElementById("txt_mail_address").value);
    document.cookie = "txt_user_name=" + encodeURIComponent(document.getElementById("txt_user_name").value);
    document.cookie = "hdn_page_no=" + document.getElementById("hdn_page_no").value;
...
function set_search_clear() {
    ...
    document.getElementById("txt_mail_address").value = "";
...
enableEnterKey(() => get_search_list(1), "txt_mail_address", "txt_user_name");
